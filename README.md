...
**A real-world data trap.** Naïve test economics looked catastrophic (-$725/loan). Diagnosis: maturity censoring on 2016–2018 vintages — only early prepayers and early defaulters had finalized by the dataset snapshot. Filtering to loans whose full term had elapsed flipped the baseline to +$530/loan and made the rest of the analysis meaningful.
